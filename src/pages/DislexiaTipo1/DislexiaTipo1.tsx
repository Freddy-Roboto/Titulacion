    ...
    <IonPage>
      <IonHeader>
        <IonToolbar>
          ...
          <IonTitle><img src= {temonet} width='50' />Crear Terapia Dislexia tipo 1</IonTitle>
        </IonToolbar>
      </IonHeader>
      ...
      <IonContent fullscreen>
        <IonHeader collapse="condense">
          <IonToolbar>
            <IonTitle size="large">Dislexia Tipo 1</IonTitle>
          </IonToolbar>
        </IonHeader>
