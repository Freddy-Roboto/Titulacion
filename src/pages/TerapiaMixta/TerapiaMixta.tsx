    ...
    <IonPage>
      <IonHeader>
        <IonToolbar>
          ...
          <IonTitle><img src= {temonet} width='50' />Crear Terapia Mixta</IonTitle>
        </IonToolbar>
      </IonHeader>
      ...
      <IonContent fullscreen>
        <IonHeader collapse="condense">
          <IonToolbar>
            <IonTitle size="large">Terapia Mixta</IonTitle>
          </IonToolbar>
        </IonHeader>
